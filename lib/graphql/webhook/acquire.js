...
function AcquireWebhookDefinition(graphqlTypes, models, isEventAllowed) {
    var _this = this;
    return {
        ...
        resolve: function (source, args, context) { return __awaiter(_this, void 0, void 0, function () {
            var eventSecurityContext, eventType, webhook;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        eventSecurityContext = args.eventSecurityContext, eventType = args.eventType;
                        return [4 /*yield*/, models.webhook.findOne({
...
exports["default"] = AcquireWebhookDefinition;
