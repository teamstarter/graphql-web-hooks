...
function HeaderConfiguration(graphqlTypes, models, getMetadataFromContext) {
    var _this = this;
    return {
        model: models.header,
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                if (Object.entries(webhook.securityMetadata).toString() ===
                                    Object.entries(securityMetadata).toString()) {
                                    return [2 /*return*/, args.header];
                                }
