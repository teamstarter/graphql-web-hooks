    ...
    return {
        ...
        list: {
            beforeList: function (_a) {
                ...
                if ((_c = hook === null || hook === void 0 ? void 0 : hook.list) === null || _c === void 0 ? void 0 : _c.before) {
                    hook.list.before({ findOptions: findOptions, args: args, context: context });
                }
                return findOptions;
            },
            afterList: function (_a) {
                var _b;
                ...
                if ((_b = hook === null || hook === void 0 ? void 0 : hook.list) === null || _b === void 0 ? void 0 : _b.after) {
                    hook.list.after({ result: result, args: args, context: context, info: info });
                }
                return result;
            }
        },
        create: {
            beforeCreate: function (_a) {
                ...
                if ((_b = hook === null || hook === void 0 ? void 0 : hook.create) === null || _b === void 0 ? void 0 : _b.before) {
                    hook.create.before({ source: source, args: args, context: context });
                }
                args.webhook.securityMetadata = getMetadataFromContext(context);
                return args.webhook;
            },
            afterCreate: function (_a) {
                var webhook = _a.createdEntity, source = _a.source, args = _a.args, context = _a.context;
                return __awaiter(_this, void 0, void 0, function () {
                    var _b, _c;
                    return __generator(this, function (_d) {
                        if ((_b = hook === null || hook === void 0 ? void 0 : hook.create) === null || _b === void 0 ? void 0 : _b.after) {
                            (_c = hook.create) === null || _c === void 0 ? void 0 : _c.after({ createdEntity: webhook, source: source, args: args, context: context });
                        }
        ...
        update: {
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        if ((_b = hook === null || hook === void 0 ? void 0 : hook.update) === null || _b === void 0 ? void 0 : _b.before) {
                            hook.update.before({ source: source, args: args, context: context });
                        }
            ...
            afterUpdate: function (_a) {
                var webhook = _a.updatedEntity, oldWebhook = _a.previousPropertiesSnapshot, source = _a.source, args = _a.args, context = _a.context;
                return __awaiter(_this, void 0, void 0, function () {
                    var _b;
                    return __generator(this, function (_c) {
                        if ((_b = hook === null || hook === void 0 ? void 0 : hook.update) === null || _b === void 0 ? void 0 : _b.after) {
                            hook.update.after({ updatedEntity: webhook, previousPropertiesSnapshot: oldWebhook, source: source, args: args, context: context });
                        }
                        return [2 /*return*/, webhook];
                    });
                });
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        if ((_b = hook === null || hook === void 0 ? void 0 : hook["delete"]) === null || _b === void 0 ? void 0 : _b.before) {
                            hook["delete"].before({ where: where, source: source, args: args, context: context });
                        }
                        return [2 /*return*/, where];
                    });
                });
            },
            afterDelete: function (_a) {
                        ...
                        switch (_c.label) {
                            case 0:
                                if ((_b = hook === null || hook === void 0 ? void 0 : hook["delete"]) === null || _b === void 0 ? void 0 : _b.after) {
                                    hook["delete"].after({ deletedEntity: deletedWebhook, source: source, args: args, context: context });
                                }
