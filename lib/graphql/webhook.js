    ...
    return {
        ...
        create: {
            before: function (source, args, context) {
                var _a;
                (_a = hook === null || hook === void 0 ? void 0 : hook.create) === null || _a === void 0 ? void 0 : _a.before(source, args, context);
        ...
        update: {
            before: function (source, args, context) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    (_a = hook === null || hook === void 0 ? void 0 : hook.update) === null || _a === void 0 ? void 0 : _a.before(source, args, context);
            ...
            after: function (webhook, oldWebhook, source, args, context) { return __awaiter(_this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    (_a = hook === null || hook === void 0 ? void 0 : hook.update) === null || _a === void 0 ? void 0 : _a.after(webhook, oldWebhook, source, args, context);
                    return [2 /*return*/, webhook];
                });
            }); }
        },
        "delete": {
            before: function (where, source, args, context) { return __awaiter(_this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    (_a = hook === null || hook === void 0 ? void 0 : hook["delete"]) === null || _a === void 0 ? void 0 : _a.before(where, source, args, context);
            ...
            after: function (deletedWebhook, source, args, context) { return __awaiter(_this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    (_a = hook === null || hook === void 0 ? void 0 : hook["delete"]) === null || _a === void 0 ? void 0 : _a.after(deletedWebhook, source, args, context);
                    return [2 /*return*/, deletedWebhook];
                });
            }); }
        }
    };
